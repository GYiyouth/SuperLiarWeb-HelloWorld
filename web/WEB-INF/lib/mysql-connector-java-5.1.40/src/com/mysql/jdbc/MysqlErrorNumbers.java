...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_TOO_MANY_USER_CONNECTIONS = 1203; //SQLSTATE: 42000 Message: UserBean %s already has more than 'max_user_connections' active connections
    ...
    public final static int ER_USER_LIMIT_REACHED = 1226; //SQLSTATE: 42000 Message: UserBean '%s' has exceeded the '%s' resource (current value: %ld)
